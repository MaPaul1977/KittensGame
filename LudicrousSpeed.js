...
var autoName = ['build', 'craft', 'hunt', 'trade', 'praise', 'science', 'upgrade', 'party', 'assign', 'energy', 'elder', 'ludicrous'];
...
'<button id="ludiSpeed" style="color:red" onclick="autoSwitch(autoCheck[11], 11, autoName[11], \'ludiSpeed\')"> Ludicrous Speed </button></br></br>' +
